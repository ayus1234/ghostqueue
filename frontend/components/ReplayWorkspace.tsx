  ...
  if (!isCapabilityAvailable || !replayData) {
    return (
      <div className="space-y-4">
        ...
        />
        {onLoadSyntheticDemo && (
          <div className="rounded-xl border border-indigo-900/40 bg-indigo-950/20 p-5 text-center">
            <h4 className="text-sm font-semibold text-indigo-300">
              Explore Ghost Replay with the Synthetic Replay Fixture
            </h4>
            <p className="mt-1 text-xs text-indigo-200/80 max-w-md mx-auto">
            ...
            <button
              ...
              className="mt-3 inline-flex items-center gap-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 px-4 py-2 text-xs font-semibold text-white transition-colors"
            >
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/60 p-4">
          ...
          <div className="mt-1 text-base font-bold font-mono text-amber-300 truncate">
            ...
            {sessions.map((sess) => {
              ...
              return (
                ...
                >
                  ...
                  {sess.ghost_point && (
                    <div className="mt-2 rounded border border-rose-900/30 bg-rose-950/20 px-2 py-1 text-[11px] text-rose-300">
          ...
          {currentSession ? (
            <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/60 p-6 backdrop-blur-sm shadow-sm">
              ...
              <div className="border-b border-zinc-800/80 pb-4">
                ...
                <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs font-mono">
                  <div className="rounded-lg bg-zinc-950/60 border border-zinc-800 p-2.5">
                    <span className="text-zinc-400 text-[10px] uppercase">Duration</span>
                    <div className="font-semibold text-white">
                      {currentSession.journey_duration_seconds.toFixed(1)}s
                    </div>
                  </div>
                  <div className="rounded-lg bg-zinc-950/60 border border-zinc-800 p-2.5">
                    <span className="text-zinc-400 text-[10px] uppercase">Total Steps</span>
                    <div className="font-semibold text-white">
                      {currentSession.total_steps}
                    </div>
                  </div>
                  <div className="rounded-lg bg-zinc-950/60 border border-zinc-800 p-2.5">
                    <span className="text-zinc-400 text-[10px] uppercase">Queues</span>
                    <div className="font-semibold text-zinc-200 truncate">
                      {currentSession.queues_traversed.join(", ") || "None"}
                    </div>
                  </div>
                  <div className="rounded-lg bg-zinc-950/60 border border-zinc-800 p-2.5">
                    <span className="text-zinc-400 text-[10px] uppercase">Terminal Event</span>
              ...
              {currentSession.ghost_point && (
                <div className="mt-5 rounded-xl border border-rose-900/50 bg-rose-950/30 p-4">
                  <div className="flex items-start gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-rose-900/60 text-rose-300 shrink-0">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="rounded bg-rose-900/80 px-1.5 py-0.2 text-[10px] font-mono text-rose-100">
              ...
              <div className="mt-6">
                <h4 className="text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-4 flex items-center gap-1.5">
                      ...
                      >
                        ...
                        <div
                          className={`absolute -left-6 top-1 h-3.5 w-3.5 rounded-full border-2 transition-colors ${
                            isGhostStep
                              ? "bg-rose-500 border-rose-300 ring-4 ring-rose-950/80 animate-pulse"
                        ...
                        >
                          ...
                          <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-zinc-400">
                            {evt.queue && <span>Queue: <strong className="text-zinc-300">{evt.queue}</strong></span>}
                            <span>Status: <strong className="text-zinc-300">{evt.status}</strong></span>
            ...
            <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/60 p-8 text-center text-zinc-400">
